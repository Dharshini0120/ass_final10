...
const HomeAssessmentSection: React.FC = () => {
    ...
    return (
        <Box sx={{ pt: { xs: 2, md: 2 }, pb: { xs: 6, md: 10 }, mt: { xs: 0, md: 10 }, backgroundColor: '#ffffff' }}>
            <Container maxWidth="xl" sx={{ mt: { xs: 0, md: 0 } }}>
                {/* Section Heading */}
                <Typography
                    variant="h3"
                    sx={{
                ...
                <Box
                    sx={{
                        ...
                        gap: { xs: 3, md: 4, lg: 6 }, // consistent gap for all breakpoints
                        alignItems: 'stretch',
                ...
                >
                    ...
                    >
                        <img
                            ...
                            style={{
                                ...
                                objectFit: 'cover',
                                boxShadow: '0 16px 40px rgba(0,0,0,0.15)', // stronger shadow
                            }}
                        />
                    </Box>
                    ...
                    <Box
                        sx={{
                            ...
                            gap: 4, // consistent gap for all breakpoints
                        ...
                        {features.map((feature, index) => (
                            <Card
                                ...
                                sx={{
                                    ...
                                    maxWidth: 600,
                                    mx: 'auto',
                                    background: selectedIndex === index ? 'rgba(59, 130, 246, 0.06)' : '#fff',
                                    cursor: 'pointer',
                            ...
                            >
                                <CardContent
                                    sx={{
                                        p: { xs: 2, md: 2.5 },
                                        position: 'relative',
                                        pr: { xs: 2, md: 10 }, // enough right padding for image
                                        pb: { xs: 2, md: 4 },  // enough bottom padding for image
                                    }}
                                >
                                    <Box
                                        sx={{
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <img
                                                    src={typeof feature.img === 'string' ? feature.img : feature.img.src}
                                                    alt={feature.title}
                                                    style={{
                                                        width: 32,
                                                        height: 32,
                                        ...
                                        <Box
                                            sx={{
                                                ...
                                                position: 'absolute',
                                                // Remove right/bottom from sx, use CSS class instead
                                            }}
